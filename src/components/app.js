...
export default class App extends Component {
  ...
  render() {
    let stockList = this.state.stocks.map(stock => <StockCard stock={stock} />)
    ...
    return (
      <div class="p-4">
        ...
        <main>
          <form class="flex justify-start" onSubmit={this.handleSubmitForm}>
            <input
            ...
            />
            <input
              class={cn("btn btn-blue shadow-md", {
