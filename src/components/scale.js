...
export default props => {
  const { high, low, value, fadeDown } = props
  ...
  let boxClass = cn(
    "border-3 border-solid border-r-none w-16 h-full ml-4 pl-2 text-white font-bold relative flex flex-col justify-between",
    { "border-gradient-down": fadeDown, "border-gradient-up": !fadeDown }
  )
